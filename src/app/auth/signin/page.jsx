            ...
            <Card className="w-full max-w-md p-6 shadow-sm border border-zinc-200 dark:border-zinc-800">
                ...
                <form onSubmit={handleSignin} className="flex flex-col gap-5">
                    ...
                    <Button
                        type="submit"
                        color="primary"
                        className="w-full font-semibold rounded-xl text-sm bg-green-500 h-12"
                        isLoading={isLoading}
                    ...
                    <div className="text-center pt-4 border-t border-zinc-100 dark:border-zinc-800 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                        New to HireLoop?{" "}
                        <Link href={`/auth/signup?redirect=${encodeURIComponent(redirectTo)}`} className="font-medium cursor-pointer text-sm text-green-600">
                            Create an account
                        </Link>
                    </div>
